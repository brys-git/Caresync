...
<div class="row justify-content-center">
    <div class="col-xl-10">
        <section class="cs-panel mb-4">
            <div class="cs-panel__body p-4 p-lg-5">
                ...
                <?php if ($pendingStatus === 'pending'): ?>
                    <div class="alert alert-info">
                        Your Damayan Burial Program plan registration was submitted on <?= cs_date($pending_registration['created_at'] ?? null) ?> and is currently pending approval.
                    </div>
