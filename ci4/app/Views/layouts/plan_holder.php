...
<head>
    ...
    <title><?= esc($page_title ?? 'CareSync Plan Holder') ?></title>
    ...
    <div class="container-scroller">
        <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
            <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-start">
                <a class="navbar-brand brand-logo" href="<?= base_url('client/dashboard') ?>"><img src="<?= base_url('purpleadmin/assets/images/logo.svg?v=2') ?>" alt="logo" /></a>
                <a class="navbar-brand brand-logo-mini" href="<?= base_url('client/dashboard') ?>"><img src="<?= base_url('purpleadmin/assets/images/logo-mini.svg?v=2') ?>" alt="logo" /></a>
            </div>
                ...
                <div class="search-field d-none d-md-block">
                    <form class="d-flex align-items-center h-100" action="#">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control bg-transparent border-0" placeholder="Search your account">
                        </div>
                    </form>
                </div>
                    ...
                    <li class="nav-item nav-profile dropdown">
                        <a class="nav-link dropdown-toggle" id="profileDropdown" href="#" data-bs-toggle="dropdown" aria-expanded="false">
                            ...
                            <div class="nav-profile-text">
                                <p class="mb-1 text-black"><?= esc(trim((string) (session()->get('first_name') . ' ' . session()->get('last_name'))) ?: ($plan_holder_name ?? 'Plan Holder')) ?></p>
                            </div>
                        </a>
            ...
            <div class="main-panel">
                        ...
                        <div class="page-header">
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Plan Holder</li>
                                </ol>
                            </nav>
                        </div>
                    <?php endif ?>
                ...
                <footer class="footer">
                    <div class="d-sm-flex justify-content-center justify-content-sm-between">
                        <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">© <?= date('Y') ?> CareSync Plan Holder.</span>
                        <span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center">Your plan history in one place.</span>
                    </div>
                </footer>
            </div>
        </div>
