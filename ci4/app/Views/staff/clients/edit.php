...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <a href="<?= base_url('staff/client/view/' . $client['plan_holder_id']) ?>" class="btn btn-outline-secondary btn-sm">Back to Details</a>
    </div>
    ...
    <div class="card">
        <div class="card-body">
            <form method="post" action="<?= base_url('staff/client/update/' . $client['plan_holder_id']) ?>">
                <?= csrf_field() ?>
