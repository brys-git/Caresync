...
<?php
$packageName = (string) ($package['package_name'] ?? 'Wood Casket');
...
<div class="sc">
    <div class="sc-container">
        ...
        <!-- ====== Page Hero ====== -->
        <div class="sc-page-hero" style="background-image: url('<?= base_url('assets/images/product-1.png') ?>');">
            ...
            <div class="sc-page-hero__content">
                ...
                <p class="sc-page-hero__sub">Premium solid-wood casket with elegant finish and complete memorial inclusions. Multiple variants and optional burial attire available.</p>
            </div>
        </div>
        ...
        <div class="sc-detail-grid">
            ...
            <div class="sc-detail-main">
                ...
                <div class="sc-detail-hero">
                    <img src="<?= base_url('assets/images/product-1.png') ?>" alt="<?= esc($packageName) ?>">
                </div>
                ...
                <div class="sc-block">
                    <div class="sc-block__head">
                        ...
                        <div>
                            ...
                            <div class="sc-block__sub">Elegant memorial casket with complete inclusions</div>
                        </div>
                    </div>
                    <div class="sc-block__body">
                        <p><?= nl2br(esc($packageDesc)) ?></p>
                        <p style="margin-top:12px;">Each Wood Casket package includes professional preparation, a memorial service arrangement, and all standard inclusions listed below. Choose from our range of wood finishes to honor your loved one with dignity.</p>
                    </div>
                </div>
                ...
                <div class="sc-block">
                    <div class="sc-block__head">
                        ...
                        <div>
                            ...
                            <div class="sc-block__sub">Choose the wood finish and size that suits your needs</div>
                        </div>
                    </div>
                    <div class="sc-block__body">
                ...
                <div class="sc-block">
                    <div class="sc-block__head">
                        ...
                        <div>
                            ...
                            <div class="sc-block__sub">8 standard inclusions with every Wood Casket package</div>
                        </div>
                    </div>
                    <div class="sc-block__body">
                        <div class="sc-inclusion-grid">
                            ...
                            <?php else: ?>
                                <?php
                                $defaultInclusions = [
                                    'Solid wood casket with premium finish',
            ...
            <div class="sc-detail-sidebar">
                <div class="sc-price-summary" id="sc-price-summary">
                    ...
                    <div class="sc-price-summary__trust">
                        ...
                        <div class="sc-trust-item"><i class="mdi mdi-coffin"></i> Premium Quality</div>
...
(function() {
    ...
    function scCalculateTotal() {
        ...
        if (isDamayanMember && damayanRow) {
            // Benefit applies to packages > 20K
